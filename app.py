...
def main_entry():
    ...
    Total_Relationship_Count = st.number_input('NOMBRE DE PRODUITS DETENUS')

    # slider dans la sidebar pour les variable quantitative:
    Contacts_Count_12_mon = st.number_input('NOMBRE DE CONTACT AU COURS DES 12 DERNIERS MOIS')

    # slider dans la sidebar pour les variable quantitative:
    Credit_Limit = st.number_input('LIMITE DE CREDIT SUR LA CARTE')

    # slider dans la sidebar pour les variable quantitative:
    Total_Revolving_Bal = st.number_input('SOLDES TOTAL RENOUVELABLE')

    # slider dans la sidebar pour les variable quantitative:
    Avg_Open_To_Buy = st.number_input('LIGNE DE CREDIT OUVERT A L\'ACHAT')

    # slider dans la sidebar pour les variable quantitative:
    Total_Trans_Amt = st.number_input('MONTANT TOTAL DES TRANSACTIONS')

    # slider dans la sidebar pour les variable quantitative:
    Total_Trans_Ct = st.number_input('NOMBRE TOTAL DE TRANSACTIONS')
...
#st.write('\n\n\n\n\n\n')
#st.form_submit_button(onclick = label ='SOUMETTRE')
